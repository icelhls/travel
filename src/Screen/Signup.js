        ...
        try {
          ...
          if (type === 'success') {
           ...
           /// Alert.alert('Logged in!', `Hi ${(await response.json())}!`);
            ...
            axios.post(serverpoint.servername+"/signupfacebook", {fid:finalresponse.id,name:finalresponse.name })
            .then(res => {
    ...
    return retrievedItem;
      ...
      async function googlelogin(){
        const { type, accessToken, user } = await Google.logInAsync({
          ...
          androidClientId: '1058542661103-stjukh4vl9m06be8m6m7l0g8ihsv9gch.apps.googleusercontent.com',
        ...
        if (type === 'success') {
          ...
          axios.post(serverpoint.servername+"/signupgoogle", {email:user.email,gid:user.id,img:user.photoUrl })
          .then(res => {
...
if (validcpass()) {
 ...
 if(validcpass()  && validname() && validpass() && validusername()){
    ...
    axios.post(serverpoint.servername+"/signupemail", {name:name ,email:username,pass:pass})
   .then(res => {
...
<Image
        ...
        />
                ...
                <Text style={{ fontSize: 16, color: 'gray', marginTop: 20 }}>Sign up in to continue</Text>
                ...
                <View style={{ alignItems: 'center', justifyContent: 'center', marginTop: 10 }}>
                    ...
                    <View style={{ flexDirection: 'row', marginTop: 20 }}>
                        <View 
                        style={{ height: 40, width: 40, borderRadius: 40/2, backgroundColor: '#3f51b5', alignItems: 'center', justifyContent: 'center' }}>
                            <Text style={{ fontSize: 25, fontWeight: 'bold', color: '#FFF' }} onPress={facebooklogIn}>f</Text>
                        </View>
                        ...
                        <Text style={{ fontSize: 25, fontWeight: 'bold', color: '#FFF' }} onPress={googlelogin}>G</Text>
                        </View>
